...
type Items struct {
	...
	HasMore    string  `json:"@odata.nextLink"`
}
...
type FileSharingInfo struct {
	...
	SharedBy       *IdentitySet `json:"sharedBy"`
...
type Item struct {
	...
	Shared               *FileSharingInfo `json:"shared"`
	// Instance attributes
...
// Download
func (is ItemService) Download(itemID string) (*http.Response, error) {
